...
public interface PostController {
    ...
    ResponseEntity<?> apiV1PostsPost(@ApiParam(value = "" ,required=true ) @RequestBody PostDTO postEdit, BindingResult bindingResult) throws DtoValidationFailedException, DuplicateEntityException, DependencyNotFoundException;
    ...
    ResponseEntity<?> apiV1PostsPut(@ApiParam(value = "" ,required=true ) @RequestBody PostDTO postEdit, BindingResult bindingResult) throws DtoValidationFailedException, EntityIsNotExistingException, DuplicateEntityException, DependencyNotFoundException;
    ...
    @ApiOperation(value = "Posts from Tag", notes = "Returns all posts from defined Tag.", response = String.class, responseContainer = "List", tags={ "Posts", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Post links.", response = String.class),
        @ApiResponse(code = 400, message = "Bad request (validation failed).", response = String.class),
        @ApiResponse(code = 401, message = "Untagized (need to log in / get token).", response = String.class),
        @ApiResponse(code = 403, message = "Forbidden (no rights to access resource).", response = String.class),
    ...
    @ApiOperation(value = "Posts from Tag and Status", notes = "Returns all posts from defined Tag and Status.", response = String.class, responseContainer = "List", tags={ "Posts", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "Post links.", response = String.class),
        @ApiResponse(code = 400, message = "Bad request (validation failed).", response = String.class),
        @ApiResponse(code = 401, message = "Untagized (need to log in / get token).", response = String.class),
