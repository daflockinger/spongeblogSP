...
public interface CategoryController {
    ...
    @ApiOperation(value = "Delete Category", notes = "Deletes a Category with defined Id.", response = Void.class, tags={ "Categories", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "Create Category", notes = "Creates new Category entry.", response = CategoryDTO.class, tags={ "Categories", })
    @ApiResponses(value = { 
