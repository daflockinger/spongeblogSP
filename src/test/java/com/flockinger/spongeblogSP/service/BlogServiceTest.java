...
public class BlogServiceTest extends BaseServiceTest {
  ...
  public void testCreate_withValidBlog_shouldWork()
    ...
    assertThat(savedBlog.getSettings()).containsAllEntriesOf(
        ImmutableMap.of("text-color", "white", "background-image", "bunny.jpg"));
  }

  @Test
  @FlywayTest(locationsForMigrate = {"/db/testfill/"})
  public void testUpdate_withValidBlog_shouldWork()
      throws EntityIsNotExistingException, DuplicateEntityException {
    BlogDTO savedBlog = service.getBlog();
  ...
  @FlywayTest(locationsForMigrate = {"/db/testfill/"})
  public void test_createBlog_whenItalreadyExists_shouldThrowException()
  ...
  @FlywayTest(locationsForMigrate = {"/db/testfill/"})
  public void testUpdateBlog_withEmptyName_shouldThrowException()
  ...
  @Test(expected = TransactionSystemException.class)
  @FlywayTest(locationsForMigrate = {"/db/testfill/"})
  public void testUpdateBlog_withMissingStatus_shouldThrowException()
      throws EntityIsNotExistingException {
    BlogDTO fakeBlog = new BlogDTO();
  ...
  @FlywayTest(invokeCleanDB = true)
  public void test_deleteBlog_withNotExistingId_shouldThrowException()
      throws EntityIsNotExistingException {
    service.deleteBlog();
  }
