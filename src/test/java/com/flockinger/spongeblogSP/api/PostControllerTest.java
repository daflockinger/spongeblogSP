...
public class PostControllerTest extends BaseControllerTest{
	...
	public void testApiV1PostsGet_withNoPaginationSettingsAndEmptyDB_shouldReturnEmpty() throws Exception {
		mockMvc.perform(get("/api/v1/posts")
	               .contentType(jsonContentType))
					.andExpect(status().isOk())
	...
	public void testApiV1PostsPostIdGet_withNotExistngId_shouldReturnNotFound() throws Exception {
		mockMvc.perform(get("/api/v1/posts/34341")
	               .contentType(jsonContentType))
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsAuthorUserIdGet_withValidUserAndPaging_shouldCorrect() throws Exception {
	...
	@Test
	public void testApiV1PostsAuthorUserIdGet_withNonExistingUser_shouldReturnEmpty() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsAuthorUserIdStatusGet_withValidAndStatusAndPaging_should() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsAuthorUserIdStatusGet_withInvalidUser_shouldReturnEmpty() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsAuthorUserIdStatusGet_withInvalidStatus_shouldReturnConflict() throws Exception {
		mockMvc.perform(get("/api/v1/posts/author/1/BLA")
	               .contentType(jsonContentType))
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsAuthorUserIdStatusGet_withInvalidStatusAndInvalidUser_shouldConflict() throws Exception {
		mockMvc.perform(get("/api/v1/posts/author/7657571/BLA")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	public void testApiV1PostsPostIdDelete_withNotExistingId_shouldReturnNonFound() throws Exception {
		mockMvc.perform(delete("/api/v1/posts/7657651")
	               .contentType(jsonContentType))
	                .andExpect(status().isNotFound());
	}
	...
	public void testApiV1PostsPostIdDelete_withInvalidId_shouldReturnBadRequest() throws Exception {
		mockMvc.perform(delete("/api/v1/posts/bla")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	@Test
	public void testApiV1PostsPost_withAllMessedUpPost_shouldReturnReallyBadRequest() throws Exception {
		PostDTO freshPost = new PostDTO();
		freshPost.setAuthor(getTestUser(1l));
		freshPost.setCategory(null);
		freshPost.setContent(null);
	...
	@Test
	public void testApiV1PostsPut_withAllMessedUpPost_shouldReturnReallyBadRequest() throws Exception {
		PostDTO freshPost = new PostDTO();
		freshPost.setAuthor(getTestUser(1l));
		freshPost.setCategory(null);
		freshPost.setContent(null);
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdGet_withValidCategoryAndPaging_shouldCorrect() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdGet_withValidCategory_shouldCorrect() throws Exception {
	...
	@Test
	public void testApiV1PostsCategoryCategoryIdGet_withNonExistingCategory_shouldReturnEmpty() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdStatusGet_withValidAndStatusAndPaging_should() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdStatusGet_withValidCategoryAndStatus_should() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdStatusGet_withInvalidCategory_shouldReturnEmpty() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdStatusGet_withInvalidStatus_shouldReturnConflict() throws Exception {
		mockMvc.perform(get("/api/v1/posts/category/1/BLA")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsCategoryCategoryIdStatusGet_withInvalidStatusAndInvalidCategory_shouldConflict() throws Exception {
		mockMvc.perform(get("/api/v1/posts/category/7657571/BLA")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsTagTagIdStatusGet_withValidAndStatusAndPaging_should() throws Exception {
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsTagTagIdStatusGet_withInvalidStatus_shouldReturnConflict() throws Exception {
		mockMvc.perform(get("/api/v1/posts/tag/1/BLA")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsTagTagIdStatusGet_withInvalidStatusAndInvalidTag_shouldConflict() throws Exception {
		mockMvc.perform(get("/api/v1/posts/tag/7657571/BLA")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsStatusStatusGet_withValidStatusAndPaging_shouldCorrect() throws Exception {
	...
	@Test
	public void testApiV1PostsStatusStatusGet_withNonExistingStatus_shouldReturnBadRequest() throws Exception {
		mockMvc.perform(get("/api/v1/posts/status/nonexista")
	               .contentType(jsonContentType))
	                .andExpect(status().isBadRequest());
	}
	...
	public void testApiV1PostsRewindPostIdPut_withExistingPrevVersion_shouldRewind() throws Exception {
		...
		mockMvc.perform(put("/api/v1/posts/rewind/" + savedPost.getPostId())
	               .contentType(jsonContentType))
	                .andExpect(status().isOk());
	...
	@Test
	@FlywayTest(locationsForMigrate = { "/db/testfill/" })
	public void testApiV1PostsRewindPostIdPut_withNoPreviousVersion_shouldReturnConflict() throws Exception {
		mockMvc.perform(put("/api/v1/posts/rewind/1")
	               .contentType(jsonContentType))
	                .andExpect(status().isConflict());
	}
