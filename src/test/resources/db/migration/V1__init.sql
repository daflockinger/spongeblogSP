...
create index IDX2jm25hjrq6iv4w8y1dhi0d9p4 on post (title) using HASH;
create index IDXik65bluepv8oxdfvgbj5qdcsj on post (author_id) using HASH;
create index IDXk7qygdxxdcc6x2fi4rx4m6t78 on post (author_id, category_id) using HASH;
create index IDXqyeor3ogkedwcmi2eent46bc8 on post (author_id, status) using HASH;
create index IDX8dd576pcv8njjj0syh5li09vs on post (status) using HASH;
create index IDXaiqakbe9ybd4im6cce323g78w on post (status, category_id) using HASH;
alter table post add constraint UK2jm25hjrq6iv4w8y1dhi0d9p4 unique (title);
create index IDX1wdpsed5kna2y38hnbgrnhi5b on tag (name) using HASH;
alter table tag add constraint UK1wdpsed5kna2y38hnbgrnhi5b unique (name);
create index IDXew1hvam8uwaknuaellwhqchhb on user (login) using HASH;
